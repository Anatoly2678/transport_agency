                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <?php if($role == Roles::Agency || $role == Roles::Admin) { ?><li><a class="dropdown-item" href="/application/applicationAgency.php">Агентство</a></li> <?php } ?>
                        </ul>
                    </li>
                    <li class="nav-item">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <?php if($role == Roles::Agency || $role == Roles::Admin) { ?><li><a class="dropdown-item" href="/agency-cabinet">Кабинет</a></li> <?php } ?>
                            <?php if($role == Roles::Admin) { ?><li><a class="dropdown-item" href="/agency-list">Список</a></li> <?php } ?>                            
                        </ul>
                    </li>
                    <?php if($role == Roles::Admin) { ?>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-bs-toggle="dropdown" aria-expanded="false">
                                Маршрут
